...
public class CreditScoreUtil {
    ...
    public static String yl_s_rcd_yebz_j3m_pct = "yl_s_rcd_yebz_j3m_pct"; //1
    public static String yl_s_amt_success_j2m_pct = "yl_s_amt_success_j2m_pct"; //2
    public static String yl_s_latesttn_fail_xj = "yl_s_latesttn_fail_xj"; //3
    public static String overdue3_1d_amt_sum_j3m = "overdue3_1d_amt_sum_j3m"; //4
    public static String sf_s_rcd_suces_dk_cnt_j6m = "sf_s_rcd_suces_dk_cnt_j6m"; //5
    public static String yl_f_mer_success_j12m_dk_cnt = "yl_f_mer_success_j12m_dk_cnt"; //6
    public static String yl_card_audit_all_rcd_disntcd_all_j1m = "yl_card_audit_all_rcd_disntcd_all_j1m"; //7
    public static String yl_s_rcd_fail_j12m_pct = "yl_s_rcd_fail_j12m_pct"; //8
    public static String yl_card_audit_dbt_rcd_nearist_days = "yl_card_audit_dbt_rcd_nearist_days"; //9
    public static String yl_card_audit_dbt_rcd_disntcd_all_j6m_min = "yl_card_audit_dbt_rcd_disntcd_all_j6m_min"; //10
    ...
    static {
        ...
        creditScoreMap.put(yl_s_rcd_yebz_j3m_pct, firstDataMap);
        ...
        creditScoreMap.put(yl_s_amt_success_j2m_pct, secondDataMap);
        ...
        creditScoreMap.put(yl_s_latesttn_fail_xj, thirdDataMap);
        ...
        creditScoreMap.put(overdue3_1d_amt_sum_j3m, fourthDataMap);
        ...
        creditScoreMap.put(yl_f_mer_success_j12m_dk_cnt, sixthDataMap);
        ...
        creditScoreMap.put(yl_card_audit_all_rcd_disntcd_all_j1m, seventhDataMap);
        ...
        creditScoreMap.put(yl_s_rcd_fail_j12m_pct, eighthDataMap);
        //dataMap.clear();
        ...
        creditScoreMap.put(yl_card_audit_dbt_rcd_nearist_days, ninthDataMap);
        ...
        creditScoreMap.put(yl_card_audit_dbt_rcd_disntcd_all_j6m_min, tenthDataMap);
        /**
    ...
    public static void main(String[] args) {
        ...
        BigDecimal r1 = CreditScoreUtil.getCreditScoreByCertScoreType(CreditScoreUtil.yl_card_audit_dbt_rcd_disntcd_all_j6m_min, number1);
        System.out.println(r1);
        
        //第2种情况：位于边界值后，但又小于下一个范围首值
        BigDecimal number2 = new BigDecimal("3.5000");
        BigDecimal r2 = CreditScoreUtil.getCreditScoreByCertScoreType(CreditScoreUtil.yl_card_audit_dbt_rcd_disntcd_all_j6m_min, number2);
        System.out.println(r2);
        
        //第3种情况：大于最大值
        BigDecimal number3 = new BigDecimal("140.0000");
        BigDecimal r3 = CreditScoreUtil.getCreditScoreByCertScoreType(CreditScoreUtil.yl_card_audit_dbt_rcd_disntcd_all_j6m_min, number3);
