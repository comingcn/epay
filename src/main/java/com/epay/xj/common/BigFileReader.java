 ...
 * @Description: 大文件读取
 * @author yanghf
 * @date 2018年6月30日 上午8:10:06
 */
public class BigFileReader {

	Logger logger = LoggerFactory.getLogger(getClass());
	
	public AtomicBoolean completeStatus = new AtomicBoolean();//所有线程完成状态
	...
	public void start(){
		...
		cyclicBarrier = new CyclicBarrier(startEndPairs.size(),new Runnable() {
			...
			public void run() {
				logger.info("use time: {},all line:{}", (System.nanoTime()-startTime)/Math.pow(10, 9),counter.get());
//				completeStatus.set(true);
				shutdown();
			}
		});
