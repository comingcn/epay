...
public class TradeDetailService {
	...
	public List<TradeDetailDO> getTradeDetailsByCertNo(String certNo,String beginTime, String endTime){
		return tradeDetailRepository.findByCertNoAndTxtDateBetween(certNo, beginTime, endTime);
	}
