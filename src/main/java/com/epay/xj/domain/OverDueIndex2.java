...
@Entity
@Table(name="CP_ODS.P1055_ODS_JV2")
public class OverDueIndex2  implements Serializable{

	private static final long serialVersionUID = -4702276808236295808L;
	@Id
	public String CERT_NO;//身份证号
//	public Integer SCORE;//信用分
	/************************ 逾期类变量***************************/
	public int YQ001=0;	//6个月	逾期一天以上	近6个月在贷款类机构逾期1天以上次数
	public int YQ002=0;	//6个月	逾期一天以上	近6个月在消费金融机构逾期1天以上次数
	public int YQ003=0;	//6个月	逾期一天以上	近6个月在银行类机构逾期1天以上次数
	public int YQ004=0;	//6个月	逾期一天以上	近6个月在小贷款类机构逾期1天以上次数
...
//	public int YQ012;	//6个月	逾期机构数	近6个月发生逾期的小贷贷款类机构数
	public int YQ013=0;	//3个月	逾期一天以上次数	近3个月在贷款类机构逾期1天以上次数
	public int YQ014=0;	//3个月	逾期一天以上次数	近3个月在消费金融机构逾期1天以上次数
	public int YQ015=0;	//3个月	逾期一天以上次数	近3个月在银行类机构逾期1天以上次数
	public int YQ016=0;	//3个月	逾期一天以上次数	近3个月在小贷贷款类机构逾期1天以上次数
...
//	public BigDecimal YQ021;	//3个月	平均逾期次数	近3个月逾期的平均每家机构逾期次数
	...
	public int YQ026=0;	//6个月	逾期天数总和	近6个月逾期1天以上天数总和
	public int YQ027=0;	//3个月	逾期天数总和	近3个月逾期1天以上天数总和
...
//	public int YQ037;	//12个月	逾期机构数	近12个月发生逾期的小贷贷款类机构数
	public int YQ038=0;	//12个月	逾期1天以上	近12个月在贷款类机构逾期1天以上的次数
	public int YQ039=0;	//12个月	逾期1天以上	近12个月在消费金融类机构逾期1天以上的次数
	public int YQ040=0;	//12个月	逾期1天以上	近12个月在银行类机构逾期1天以上的次数
	public int YQ041=0;	//12个月	逾期1天以上	近12个月在小额贷款行业逾期1天以上的次数
	public int YQ042=0;	//12个月	最大逾期次数	近12个月在消费金融机构逾期的最大每家机构逾期次数
	public int YQ043=0;	//12个月	最大逾期次数	近12个月在贷款机构逾期的最大每家机构逾期次数
	public int YQ044=0;	//12个月	最大逾期次数	近12个月在银行类机构逾期的最大每家机构逾期次数
	public int YQ045=0;	//12个月	最大逾期次数	近12个月在小贷类机构逾期的最大每家机构逾期次数
	public int YQ046=0;//6个月	最大逾期天数	6月_小贷_单机构_最大逾期天数
	public int YQ047=0;//6个月	最大逾期天数	6月_消金_单机构_最大逾期天数
	public int YQ048=0;//6个月	最大逾期天数	6月_银行_单机构_最大逾期天数
	public int YQ049=0;//6个月	最大逾期天数	6月_贷款_单机构_最大逾期天数
	public int YQ050=0;//3个月	最大逾期天数	3月_小贷_单机构_最大逾期天数
	public int YQ051=0;//3个月	最大逾期天数	3月_消金_单机构_最大逾期天数
	public int YQ052=0;//3个月	最大逾期天数	3月_银行_单机构_最大逾期天数
	public int YQ053=0;//3个月	最大逾期天数	3月_贷款_单机构_最大逾期天数
	public int YQ054=0;//1个月	最大逾期天数	1月_小贷_单机构_最大逾期天数
	public int YQ055=0;//1个月	最大逾期天数	1月_消金_单机构_最大逾期天数
	public int YQ056=0;//1个月	最大逾期天数	1月_银行_单机构_最大逾期天数
	public int YQ057=0;//1个月	最大逾期天数	1月_贷款_单机构_最大逾期天数
	public int YQ058=0;//15天	最大逾期天数	15天_小贷_单机构_最大逾期天数
	public int YQ059=0;//15天	最大逾期天数	15天_消金_单机构_最大逾期天数
	public int YQ060=0;//15天	最大逾期天数	15天_银行_单机构_最大逾期天数
	public int YQ061=0;//15天	最大逾期天数	15天_贷款_单机构_最大逾期天数
	public int YQ062=0;//15天	最大逾期天数	7天_小贷_单机构_最大逾期天数
	public int YQ063=0;//15天	最大逾期天数	7天_消金_单机构_最大逾期天数
	public int YQ064=0;//15天	最大逾期天数	7天_银行_单机构_最大逾期天数
	public int YQ065=0;//15天	最大逾期天数	7天_贷款_单机构_最大逾期天数
	public int YQ066=0;//6月	逾期1天_机构数	6月_全卡_逾期1天以上_机构数
	public int YQ067=0;//6月	逾期7天_机构数	6月_全卡_逾期7天以上_机构数
	public int YQ068=0;//6月	逾期30天_机构数	6月_全卡_逾期30天以上_机构数
	public int YQ069=0;//3月	逾期1天_机构数	3月_全卡_逾期1天以上_机构数
	public int YQ070=0;//3月	逾期7天_机构数	3月_全卡_逾期7天以上_机构数
	public int YQ071=0;//3月	逾期30天_机构数	3月_全卡_逾期30天以上_机构数
	public int YQ072=0;//15天	逾期1天_机构数	15天_全卡_逾期1天以上_机构数
	public int YQ073=0;//15天	逾期7天_机构数	15天_全卡_逾期7天以上_机构数
	public int YQ074=0;//7天	逾期1天_机构数	7天_全卡_逾期1天以上_机构数
	public int YQ075=0;//7天	逾期7天_机构数	7天_全卡_逾期7天以上_机构数
